                    ...
                    lock (LOCK)
                    {
                        if (everythingPolicy == null)
                        {
                            everythingPolicy = new CustomSerializationPolicy("OdinSerializerPolicies.Everything", true, (member) =>
                            {
                                ...
                                return !member.IsDefined<NonSerializedAttribute>(true) && !member.IsDefined<OdinNonSerializedAttribute>(true);
                            });
                        }
                    }
                }
                    ...
                    lock (LOCK)
                    {
                        if (unityPolicy == null)
                        {
                            ...
                            unityPolicy = new CustomSerializationPolicy("OdinSerializerPolicies.Unity", true, (member) =>
                            {
                                ...
                                if ((member.IsDefined<NonSerializedAttribute>(true) || member.IsDefined<OdinNonSerializedAttribute>(true)) && !member.IsDefined<OdinSerializeAttribute>())
                                {
                                    return false;
                                }
                    ...
                    lock (LOCK)
                    {
                        if (strictPolicy == null)
                        {
                            strictPolicy = new CustomSerializationPolicy("OdinSerializerPolicies.Strict", true, (member) =>
                            {
                                ...
                                if (member.IsDefined<NonSerializedAttribute>() || member.IsDefined<OdinNonSerializedAttribute>())
                                {
                                    return false;
                                }
